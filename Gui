if (game:GetService("CoreGui")):FindFirstChild("DarkWeb.Blue") and (game:GetService("CoreGui")):FindFirstChild("ScreenGui") then
	(game:GetService("CoreGui")).DarkWeb.Blue:Destroy();
	(game:GetService("CoreGui")).ScreenGui:Destroy();
end;
_G.Primary = Color3.fromRGB(15, 15, 15);
_G.Dark = Color3.fromRGB(10, 10, 10);
_G.Third = Color3.fromRGB(0, 170, 255);
...
ImageButton.MouseButton1Click:connect(function()
	(game.CoreGui:FindFirstChild("DarkWeb.Blue")).Enabled = not (game.CoreGui:FindFirstChild("DarkWeb.Blue")).Enabled;
end);
...
(getgenv()).LoadConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("DarkWeb.Blue") then
			makefolder("DarkWeb.Blue");
		end;
		if not isfolder("DarkWeb.Blue/Library/") then
			makefolder("DarkWeb.Blue/Library/");
		end;
		if not isfile(("DarkWeb.Blue/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("DarkWeb.Blue/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(SettingsLib));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("DarkWeb.Blue/Library/" .. game.Players.LocalPlayer.Name .. ".json"));
...
(getgenv()).SaveConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfile(("DarkWeb.Blue/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			...
			writefile("DarkWeb.Blue/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
		end;
	else
		return warn("Status : Undetected Executor");
	end;
...
function Update:Window(Config)
	...
	local DarkWeb.Blue = Instance.new("ScreenGui");
	DarkWeb.Blue.Name = "DarkWeb.Blue";
	DarkWeb.Blue.Parent = game.CoreGui;
	DarkWeb.Blue.DisplayOrder = 999;
	local OutlineMain = Instance.new("Frame");
	OutlineMain.Name = "OutlineMain";
	OutlineMain.Parent = DarkWeb.Blue;
	...
	CreateButton("Reset Config", function()
		if isfolder("DarkWeb.Blue") then
			delfolder("DarkWeb.Blue");
		end;
	...
	function uitab:Tab(text, img)
		...
		function main:Seperator(text)
			...
			Sep1.RichText = true;
			Sep1.Text = "DarkWeb.Blue<font color=\"rgb(255, 0, 0)\">DarkWeb.Blue</font>";
			...
			Sep3.RichText = true;
			Sep3.Text = "<font color=\"rgb(255, 0, 0)\">DarkWeb.Blue</font>DarkWeb.Blue";
